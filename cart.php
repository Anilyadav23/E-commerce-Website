...
<body>
    ...
    <!-- Main -->
        ...
        $query = "SELECT products.price AS Price, products.id, products.name AS Name FROM users_products JOIN products ON users_products.products_id = products.id WHERE users_products.users_id='$user_id' and status='Added To Cart'";
